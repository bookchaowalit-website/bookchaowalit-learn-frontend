...
const ITEMS: Item[] = [{"id": "1", "title": "Next.js mastery", "category": "Frontend", "summary": "App router patterns.", "meta": "6 modules"}];
const CATS = ["Frontend", "Data"];
...
export default function Home() {
  ...
  return (
    <Shell title="Learn Paths" subtitle="Learning tracks and modules.">
